...
//  CoolTable
//
//  Created by Mani Batra on 04/11/12.
...
- (void)drawRect:(CGRect)rect
{
    ...
    CGRect paperRect=CGRectMake(self.bounds.origin.x+paperMargin, self.bounds.origin.y, self.bounds.size.width-(2*paperMargin), self.bounds.size.height);
