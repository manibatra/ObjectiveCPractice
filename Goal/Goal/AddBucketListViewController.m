...
@interface AddBucketListViewController ()

@end

@implementation AddBucketListViewController
@synthesize goal,
note;
...
- (IBAction)saveGoal:(id)sender {
    ...
    NSManagedObject *newGoal=[NSEntityDescription insertNewObjectForEntityForName:@"BucketList" inManagedObjectContext:context];
