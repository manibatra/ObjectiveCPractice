...
-(void) createFlowerData{
    ...
    [blueFlowers addObject:[[NSMutableDictionary alloc] initWithObjectsAndKeys:@"Hyacinth_(flower)", @"name", @"hyacinth.png",@"picture",@"http://en.wikipedia.org/wiki/Hyacinth",@"url", nil]];
